...
if sys.version_info[0] == 2:
    VisdomExceptionBase = Exception         # python=2.x.x
else:
    VisdomExceptionBase = ConnectionError   # python>=3.0.0
...
class Visualizer:
    ...
    def plot_visuals(self, visuals):  # .., epoch, save_result):
    ...
    def save_to_html(self, visuals, epoch):
        """Display current results on visdom; save current results to an HTML file.
    ...
    def print_losses(self, epoch, iters, losses):
        ...
        """
        # message = '(epoch: %d, iters: %d, time: %.3f) ' % (epoch, iters, t_comp)  # removed time for brevity
    ...
    def plot_losses(self, epoch, counter_ratio, losses):
