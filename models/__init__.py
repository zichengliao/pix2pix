...
def find_model_using_name(model_name):
    ...
    """
    module_filename = "models." + model_name + "_model"
    ...
    if model is None:
        print("In %s.py, there should be a subclass of BaseModel with class \
        name that matches %s in lowercase." % (module_filename, target_model_name))
        exit(0)
