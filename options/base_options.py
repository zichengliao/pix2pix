...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='facades', help='experiment name used for subfolders of checkpoints and results')
        ...
        parser.add_argument('--n_layers_D', type=int, default=3, help='specify n_layers for netD = "basic" ')
        ...
        parser.add_argument('--batch_size', type=int, default=25, help='input batch size in training')
        parser.add_argument('--serial_batches', action='store_true', help='if true, takes images in order to make batches, otherwise - randomly')
        ...
        # parser.set_defaults(continue_train=True, epoch_from=20, gpu_ids='-1')
    ...
    def parse(self):
        ...
        opt.gpu_ids = []  # reformat opt.gpu_ids from str to list
    ...
    def gather_modified_options(self):
        ...
        opt, _ = self.parser.parse_known_args()  # get the basic options
        model_option_setter = models.get_option_setter(opt.model)           # get_option_setter defined in models.__init__.py
